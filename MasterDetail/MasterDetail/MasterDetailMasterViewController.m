...
- (void)viewDidLoad
{
    ...
    listofMovies = [NSMutableArray new];
    [listofMovies addObject:@"Movie1"];
    [listofMovies addObject:@"Movie2"];
    [listofMovies addObject:@"Movie3"];
    [listofMovies addObject:@"Movie4"];
    [listofMovies addObject:@"Movie5"];
    [listofMovies addObject:@"Movie6"];
    
    self.navigationItem.title = NSLocalizedString(@"Movies", @"Movies");
    //self.detailViewController = (MasterDetailDetailViewController *)[[self.splitViewController.viewControllers.lastObject]];
}
